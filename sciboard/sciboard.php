...
<?php if(empty($_SESSION['userId'])) {
    ...
    <table class="list-table">
        ...
        <?php
          ...
          if(strlen($title)>30)
          { //title이 30을 넘어서면 ...표시
            $title=str_replace($sciboard['title'],iconv_substr($sciboard['title'],0,30,"utf-8")."...",$sciboard['title']);
          }?>
        <tbody>
            <tr>
                <td class="list-num" width="70"><?php echo $sciboard['num']; ?></td>
                <td class="list-title" width="500"><?php
                if($sciboard['lock_post']=="1") {?>
                <a href="readOk.php?num=<?php echo $sciboard['num'];?>"><?php echo $title ?> <i class="fas fa-lock"></i> 
                <?php ;} else {?>
                <a href="readOk.php?num=<?php echo $sciboard['num'];?>"><?php echo $title; }?>
                </a></td>
                <td class="list-name" width="120"><?php echo $sciboard['name']; ?></td>
                <td class="list-date" width="100"><?php echo $sciboard['date']; ?></td>
                <td class="list-hit" width="100"><?php echo $sciboard['hit']; ?></td>
            </tr>
        </tbody>
        <?php }?>
    </table>
