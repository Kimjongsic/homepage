...
<?php
		...
		$hit = mysqli_fetch_array(mq("select * from engboard where num ='".$bno."'"));
		$hit = $hit['hit'] + 1;
		$fet = mq("update engboard set hit = '".$hit."' where num = '".$bno."'");
		$sql = mq("select * from engboard where num='".$bno."'"); /* 받아온 idx값을 선택 */
...
<!-- 글 불러오기 -->
    ...
    <div class="listbtn_wrap">
        <div class="list_wrap">
            <a class="list_btn" href="engboard.php">목록</a>
        </div>
    </div>
</body>
</html>