...
<head>
    ...
    <style type="text/css">
        ...
        .post_content {
            border-top: 3px solid rgb(52, 168, 83);
        }
        .post_bar li a:hover {
            color: rgb(52, 168, 83);
        }
...
<?php
		...
		$hit = mysqli_fetch_array(mq("select * from korboard where num ='".$bno."'"));
		$hit = $hit['hit'] + 1;
		$fet = mq("update korboard set hit = '".$hit."' where num = '".$bno."'");
		$sql = mq("select * from korboard where num='".$bno."'"); /* 받아온 idx값을 선택 */
...
<!-- 글 불러오기 -->
    ...
    <div class="listbtn_wrap">
        <div class="list_wrap">
            <a class="list_btn" href="korboard.php">목록</a>
        </div>
    </div>
</body>
</html>